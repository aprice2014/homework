...
Rating.delete_all
Rating.create("book_id" => "otrain.id", "star_rating" => "5", "review" => "Riveting!")
Rating.create("book_id" => "otrain.id", "star_rating" => "2", "review" => "About as dull as you can get.")
Rating.create("book_id" => "otrain.id", "star_rating" => "3", "review" => "Not bad.")
Rating.create("book_id" => "shadow.id", "star_rating" => "4", "review" => "Great book, and not too many pages.")
Rating.create("book_id" => "shadow.id", "star_rating" => "4", "review" => "Excellent font and margins. Story wasn't bad, either.")
Rating.create("book_id" => "shadow.id", "star_rating" => "4", "review" => "Worth reading when there isn't a hockey game on.")
Rating.create("book_id" => "shadow.id", "star_rating" => "1", "review" => "Didn't understand it at all.")
Rating.create("book_id" => "alchemist.id", "star_rating" => "2", "review" => "I thought this was about how to make gold?")
Rating.create("book_id" => "alchemist.id", "star_rating" => "4", "review" => "Suspensful plot, good characters.")
Rating.create("book_id" => "alchemist.id", "star_rating" => "5", "review" => "Perfect. A work of art.")
Rating.create("book_id" => "alchemist.id", "star_rating" => "3", "review" => "Kind of confusing.")
